...
# Code style
- YOU MUST write readable, simple, testable, code
- Keep files short and concise, it is preferred to create more files than to keep increasing existing file

# Workflow
- Research -> Plan -> Discuss -> Implement
- Write declarative code and make sure that code is written for reading first
